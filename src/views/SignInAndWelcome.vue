<template>
  <div class="card">
    <div class="flex justify-content-center flex-wrap card-container mb-5">
      <div id="welcome" class="flex align-items-center justify-content-center font-bold">
...
onMounted(async () => {
  ...
  if (spotifyTokenStore.token) {
    const response = await fetch("https://api.spotify.com/v1/me", {headers: {Authorization: "Bearer " + spotifyTokenStore.token}})
