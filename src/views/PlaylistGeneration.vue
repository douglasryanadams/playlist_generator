<template>
    <div class="p-inputgroup py-5">
      <InputText v-model="playlistName" placeholder="Playlist Name" @keyup.enter="savePlaylist"/>
      <Button label="Save and Open" severity="info" @click="savePlaylist" :disabled="playlistName.length === 0"/>
    </div>
    <div>
      <h3>Playlist Preview</h3>
      <DataTable v-if="songStore.playlist.length > 0" :value="songStore.playlist" tyleStyle="min-width: 50rem">
