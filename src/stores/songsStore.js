    ...
    () => {
        ...
        function addTrack(track) {
            ...
            for (const index in this.selectedSongs){
                if (this.selectedSongs[index]) { continue }
            ...
            if (!inserted) {
                this.errorMessage = "You may only select " + this.selectedSongs.length + " songs at once. Please remove one before adding another";
            }
        ...
        return {searchResults, selectedSongs, errorMessage, playlist, listFull: listIsFull, selectTrack: addTrack, removeSong }
    },
)